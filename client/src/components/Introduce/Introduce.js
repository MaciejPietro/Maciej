...
margin: 0;
    &::before {
        height: 2px;
        animation: drawLine3 0.8s forwards ease-out 4s;
...
&::after {
    height: 2px;
    animation: drawLine4 0.8s forwards ease-out 3.6s;
    background-color: grey;
    opacity: .6;
    content: '';
    position: absolute;
